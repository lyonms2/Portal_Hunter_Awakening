...
export const HABILIDADES_POR_ELEMENTO = {
  ...
  [ELEMENTOS.FOGO]: {
    ...
    ESCUDO_DE_CHAMAS: criarHabilidade({
      ...
      descricao: 'Cria uma barreira de fogo que reduz dano e queima atacantes',
      tipo: TIPO_HABILIDADE.DEFENSIVA,
      elemento: ELEMENTOS.FOGO,
      dano_base: 10,
      multiplicador_stat: 0.5,
      stat_primario: 'resistencia',
      efeitos_status: ['queimadura_contra_ataque'],
      alvo: 'self',
      custo_energia: 25,
      cooldown: 3,
      duracao_efeito: 2,
    ...
    EXPLOSAO_IGNEA: criarHabilidade({
      nome: 'Explosão Ígnea',
      descricao: 'Causa dano massivo em área com chamas devastadoras',
      tipo: TIPO_HABILIDADE.OFENSIVA,
    ...
    ONDA_DE_CALOR: criarHabilidade({
      nome: 'Onda de Calor',
      descricao: 'Debilita todos os inimigos com calor extremo, reduzindo agilidade',
      ...
      stat_primario: 'foco',
      efeitos_status: ['lentidao', 'queimadura'],
      alvo: 'inimigos_area',
      area: true,
      duracao_efeito: 3,
      custo_energia: 35,
    ...
    INFERNO_ETERNO: criarHabilidade({
      nome: 'Inferno Eterno',
      descricao: 'Invoca um inferno que consome tudo, causando dano massivo contínuo',
      tipo: TIPO_HABILIDADE.OFENSIVA,
  ...
  [ELEMENTOS.AGUA]: {
    ...
    PRISAO_DE_GELO: criarHabilidade({
      nome: 'Prisão de Gelo',
      descricao: 'Congela o alvo, imobilizando-o temporariamente',
      tipo: TIPO_HABILIDADE.CONTROLE,
      raridade: RARIDADE_HABILIDADE.AVANCADA,
      elemento: ELEMENTOS.AGUA,
      dano_base: 30,
    ...
    MAREMOTO: criarHabilidade({
      nome: 'Maremoto',
      descricao: 'Onda gigante que varre o inimigo causando alto dano',
      tipo: TIPO_HABILIDADE.OFENSIVA,
      raridade: RARIDADE_HABILIDADE.AVANCADA,
      elemento: ELEMENTOS.AGUA,
      dano_base: 70,
      ...
      stat_primario: 'foco',
      efeitos_status: ['empurrao', 'lentidao'],
      duracao_efeito: 2,
      custo_energia: 45,
      cooldown: 3,
      nivel_minimo: 10,
  ...
  [ELEMENTOS.TERRA]: {
    ...
    TERREMOTO: criarHabilidade({
      nome: 'Terremoto',
      descricao: 'Atordoa todos os inimigos próximos com tremor devastador',
      tipo: TIPO_HABILIDADE.CONTROLE,
      raridade: RARIDADE_HABILIDADE.AVANCADA,
      elemento: ELEMENTOS.TERRA,
      dano_base: 65,
    ...
    FURIA_TECTONICA: criarHabilidade({
      ...
      descricao: 'Fragmenta o solo causando fissuras que explodem continuamente',
      tipo: TIPO_HABILIDADE.OFENSIVA,
      raridade: RARIDADE_HABILIDADE.ULTIMATE,
      elemento: ELEMENTOS.TERRA,
      dano_base: 180,
      ...
      stat_primario: 'forca',
      efeitos_status: ['fissuras_explosivas'],
      alvo: 'inimigos_area',
      area: true,
      duracao_efeito: 3,
      custo_energia: 75,
  ...
  [ELEMENTOS.ELETRICIDADE]: {
    ...
    CAMPO_ELETRICO: criarHabilidade({
      nome: 'Campo Elétrico',
      descricao: 'Cria uma zona que causa dano a todos que entrarem',
      tipo: TIPO_HABILIDADE.CONTROLE,
      elemento: ELEMENTOS.ELETRICIDADE,
      dano_base: 15,
      multiplicador_stat: 0.7,
      stat_primario: 'foco',
      efeitos_status: ['campo_eletrico'],
      alvo: 'area',
      area: true,
      duracao_efeito: 4,
      custo_energia: 35,
    ...
    JULGAMENTO_TROVAO: criarHabilidade({
      ...
      descricao: 'Múltiplos raios celestiais devastam todos os inimigos',
      tipo: TIPO_HABILIDADE.OFENSIVA,
      raridade: RARIDADE_HABILIDADE.ULTIMATE,
      elemento: ELEMENTOS.ELETRICIDADE,
      dano_base: 220,
